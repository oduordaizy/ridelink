      ...
      <main className="min-h-screen bg-background flex flex-col items-center">
        ...
        <section className="w-full max-w-5xl mb-20 px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-card rounded-xl shadow-lg p-6 flex flex-col items-center text-center hover:-translate-y-2 transition-transform duration-300">
              ...
              <p className="text-muted-foreground">Create your free account as a driver or passenger in seconds.</p>
            </div>
            <div className="bg-card rounded-xl shadow-lg p-6 flex flex-col items-center text-center hover:-translate-y-2 transition-transform duration-300">
              <div className="w-12 h-12 mb-4 flex items-center justify-center bg-primary/10 rounded-full">
                <span className="text-2xl font-bold text-primary">2</span>
              </div>
              <h3 className="text-lg font-semibold text-foreground mb-2">Post or Find a Ride</h3>
              <p className="text-muted-foreground">Drivers post trip details. Passengers search and book available seats in real time.</p>
            </div>
            <div className="bg-card rounded-xl shadow-lg p-6 flex flex-col items-center text-center hover:-translate-y-2 transition-transform duration-300">
              <div className="w-12 h-12 mb-4 flex items-center justify-center bg-primary/10 rounded-full">
                <span className="text-2xl font-bold text-primary">3</span>
              </div>
              <h3 className="text-lg font-semibold text-foreground mb-2">Travel & Connect</h3>
              <p className="text-muted-foreground">Enjoy your journey, connect with others, and track your wallet and bookings easily.</p>
            </div>
          </div>
        </section>
