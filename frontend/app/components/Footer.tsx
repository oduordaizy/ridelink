...
export default function Footer() {
  return (
    <footer className="bg-[#00204a] border-t border-gray-800 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-start justify-between gap-12">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="text-white text-xs">
            &copy; {new Date().getFullYear()} iTravas. All rights reserved.
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-12 sm:gap-24">
          <div className="flex flex-col space-y-4">
            ...
            <ul className="flex flex-col space-y-2">
              <li><a href="/" className="text-white hover:text-[#08A6F6] transition-colors text-sm">Home</a></li>
              <li><a href="/about" className="text-white hover:text-[#08A6F6] transition-colors text-sm">About Us</a></li>
              <li><a href="/how-it-works" className="text-white hover:text-[#08A6F6] transition-colors text-sm">How It Works</a></li>
            </ul>
          </div>
          <div className="flex flex-col space-y-4">
            <h3 className="text-white font-bold text-sm uppercase tracking-wider">Support</h3>
            <ul className="flex flex-col space-y-2">
              <li><a href="/contact" className="text-white hover:text-[#08A6F6] transition-colors text-sm">Contact</a></li>
              <li><a href="/auth/register" className="text-white hover:text-[#08A6F6] transition-colors text-sm">Sign Up</a></li>
              <li><a href="/auth/login" className="text-white hover:text-[#08A6F6] transition-colors text-sm">Log In</a></li>
            </ul>
          </div>
        </div>
        ...
        {/* Right: Social Icons */}
        <div className="flex flex-col space-y-4">
          <h3 className="text-white font-bold text-sm uppercase tracking-wider">Follow Us</h3>
          <div className="flex space-x-4">
            <a href="https://twitter.com/itravas" aria-label="Twitter" className="text-white hover:text-[#08A6F6] transition-colors">
            ...
            <a href="https://facebook.com/itravas" aria-label="Facebook" className="text-white hover:text-[#08A6F6] transition-colors">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://instagram.com/itravas" aria-label="Instagram" className="text-white hover:text-[#08A6F6] transition-colors">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
