      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex space-x-6">
            ...
            <a href="https://www.facebook.com/profile.php?id=61588574262645&mibextid=rS40aB7S9Ucbxw6v" aria-label="Facebook" className="text-gray-400 hover:text-[#08A6F6] transition-colors">
