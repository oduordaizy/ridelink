        ...
        <div className="grid grid-cols-2 gap-12 sm:gap-24">
          <div className="flex flex-col space-y-4">
            ...
            <ul className="flex flex-col space-y-2">
              <li><a href="/" className="text-gray-400 hover:text-[#08A6F6] transition-colors text-sm">Home</a></li>
              <li><a href="/about" className="text-gray-400 hover:text-[#08A6F6] transition-colors text-sm">About Us</a></li>
              <li><a href="/how-it-works" className="text-gray-400 hover:text-[#08A6F6] transition-colors text-sm">How It Works</a></li>
            </ul>
          </div>
          <div className="flex flex-col space-y-4">
            <h3 className="text-white font-bold text-sm uppercase tracking-wider">Support</h3>
            <ul className="flex flex-col space-y-2">
              <li><a href="/contact" className="text-gray-400 hover:text-[#08A6F6] transition-colors text-sm">Contact</a></li>
              <li><a href="/auth/register" className="text-gray-400 hover:text-[#08A6F6] transition-colors text-sm">Sign Up</a></li>
              <li><a href="/auth/login" className="text-gray-400 hover:text-[#08A6F6] transition-colors text-sm">Log In</a></li>
            </ul>
          </div>
        </div>
