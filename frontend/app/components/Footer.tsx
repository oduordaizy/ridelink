    ...
    <footer className="bg-gradient-to-r from-blue-50 via-indigo-100 to-white border-t border-gray-100 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex space-x-4">
          <a href="#" aria-label="Twitter" className="text-indigo-500 hover:text-blue-600 transition-colors">
          ...
          <a href="#" aria-label="Facebook" className="text-indigo-500 hover:text-blue-600 transition-colors">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="#" aria-label="Instagram" className="text-indigo-500 hover:text-blue-600 transition-colors">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
