    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-100 to-white flex flex-col items-center py-12 px-4">
      <section className="max-w-3xl w-full text-center mb-12">
        ...
        <p className="text-lg md:text-xl text-indigo-600 mb-6">
          Have questions, feedback, or need help? Reach out to the RideLink team—we’re here to help you on your journey.
        </p>
      </section>
      <section className="max-w-2xl w-full bg-white/80 rounded-2xl shadow-lg p-8 mb-12">
        ...
        <div className="mt-8 text-center text-indigo-700">
          <p>Or email us at <a href="mailto:support@ridelink.com" className="underline hover:text-blue-600">support@ridelink.com</a></p>
          <p className="mt-2">RideLink HQ, 123 Shared Road, Mobility City</p>
        </div>
      </section>
      <section className="max-w-2xl w-full text-center mt-8">
        ...
        <p className="text-indigo-700 mb-6">Our team responds quickly to all inquiries. Thank you for helping us make RideLink better for everyone!</p>
      </section>
    </main>
