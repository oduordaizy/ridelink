...
MPESA_RESULT_URL = os.getenv('MPESA_RESULT_URL', f"{FRONTEND_URL}/result")
if '?' not in MPESA_RESULT_URL and MPESA_WEBHOOK_SECRET:
    MPESA_RESULT_URL = f"{MPESA_RESULT_URL}?secret={MPESA_WEBHOOK_SECRET}"

MPESA_TIMEOUT_URL = os.getenv('MPESA_TIMEOUT_URL', f"{FRONTEND_URL}/timeout")
if '?' not in MPESA_TIMEOUT_URL and MPESA_WEBHOOK_SECRET:
    MPESA_TIMEOUT_URL = f"{MPESA_TIMEOUT_URL}?secret={MPESA_WEBHOOK_SECRET}"
...
DEFAULT_FROM_EMAIL = f"iTravas <{os.getenv('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER)}>"
